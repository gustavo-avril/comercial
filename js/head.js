...
`;
// Daniel Cuello
document.getElementById("head-cba").innerHTML = `
<div class="head d-block">
  <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
    <div class="mainflip">
      <div class="frontside">
        <div class="card">
          <div class="card-body">
            <p class="inner">
              <img src="./images/organigrama/danielC.webp" alt="Daniel Cuello" class="inner-image">
            </p>
            <div class="contenido">
              <p class="nombre">Daniel Cuello</p>
              <p class="cargo">Head of Commercial & Business - Córdoba</p>
            </div>
          </div>
        </div>
      </div>
      <div class="backside">
        ...
        <div class="card">
          <div class="card-body comercial">
            <div class="mb-2">
              <p class="titulo text-center">Head of Commercial & Business - Córdoba</p>
            </div>
            <div>
              <p class="text-center"><i class="ti-email"></i></p>
